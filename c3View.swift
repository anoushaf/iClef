    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack{
                ...
                Image("alto3-" + String(self.cardNum)).resizable()
                    .scaledToFit()
                ...
                HStack{
                    ...
                    Button(action: {
                        ...
                        if(self.cardNum < 1){
                         ...
                         if(self.cardNum < 8 && self.cardNum > 0 ){
                             self.octave = 2
                         }
                        else if(self.cardNum >= 8 && self.cardNum < 15){
                             self.octave = 3
                         }
                         else if(self.cardNum >= 15){
                              self.octave = 4
                          }
                        self.result = -1
                        if(self.played == 0){
                        ...
                        self.played = 0
                        if(self.cardNum % 7 > 5){
                            self.index = (self.cardNum % 7) - 6
                            
                        }
                        else{
                            self.index = (self.cardNum % 7) + 1
